...
export const assingment31 = () => {
    printColoredMessage("Question: No Users: Add an if test to Exercise 28 to make sure the list of users is not empty.\nIf the list is empty, print the message 'We need to find some users!'\nRemove all of the usernames from your array, and make sure the correct message is printed.");
...
// assingment 32
export const assingment32 = () => {
    printColoredMessage("Question: Checking Usernames: Do the following to create a program that simulates how websites ensure that everyone has a unique username.\nMake a list of five or more usernames called current_users.\nMake another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.\nLoop through the new_users list to see if each new username has already been used. If it has, print a message that the person will need to enter a new username. If a username has not been used, print a message saying that the username is available.\nMake sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted.");
    let current_users = ["Alice", "Bob", "Charlie", "David", "Eve"];
    let new_users = ["Frank", "Alice", "Grace", "John", "Eve"];
...
// assingment 33
export const assingment33 = () => {
    printColoredMessage("Question: Ordinal Numbers: Ordinal numbers indicate their position in an array, such as 1st or 2nd. Most ordinal numbers end in th, except 1, 2, and 3.\nStore the numbers 1 through 9 in an array.\nLoop through the array.\nUse an if-else chain inside the loop to print the proper ordinal ending for each number. Your output should read '1st 2nd 3rd 4th 5th 6th 7th 8th 9th', and each result should be on a separate line.");
...
// assingment 34
export const assingment34 = () => {
    printColoredMessage("Question: Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in an array, and then use a for loop to print the name of each pizza.\nModify your for loop to print a sentence using the name of the pizza instead of printing just the name of the pizza. For each pizza you should have one line of output containing a simple statement like 'I like pepperoni pizza'.\nAdd a line at the end of your program, outside the for loop, that states how much you like pizza. The output should consist of three or more lines about the kinds of pizza you like and then an additional sentence, such as 'I really love pizza!'");
...
export const assingment35 = () => {
    printColoredMessage("Question: Animals: Think of at least three different animals that have a common characteristic. Store the names of these animals in a list, and then use a for loop to print out the name of each animal.\nModify your program to print a statement about each animal, such as 'A dog would make a great pet'.\nAdd a line at the end of your program stating what these animals have in common. You could print a sentence such as 'Any of these animals would make a great pet!'");
...
// assingment 36
export const assingment36 = () => {
    printColoredMessage("Question: T-Shirt: Write a function called make_shirt() that accepts a size and the text of a message that should be printed on the shirt. The function should print a sentence summarizing the size of the shirt and the message printed on it. Call the function.");
...
// assingment 37
export const assingment37 = () => {
    printColoredMessage("Question: Large Shirts: Modify the make_shirt() function so that shirts are large by default with a message that reads 'I love TypeScript'. Make a large shirt and a medium shirt with the default message, and a shirt of any size with a different message.");
...
// assingment 38
export const assingment38 = () => {
    printColoredMessage("Question: Cities: Write a function called describe_city() that accepts the name of a city and its country. The function should print a simple sentence, such as 'Karachi is in Pakistan'. Give the parameter for the country a default value. Call your function for three different cities, at least one of which is not in the default country.");
    const describe_city = (city, country = "Default Country") => {
        console.log(`${city} is in ${country}.`);
    };
    describe_city("Karachi", "Pakistan");
};
// assingment 39
export const assingment39 = () => {
    printColoredMessage("Question: City Names: Write a function called city_country() that takes in the name of a city and its country. The function should return a string formatted like this: 'Lahore, Pakistan'. Call your function with at least three city-country pairs, and print the value that’s returned.");
...
// assingment 42
export const assingment42 = () => {
    printColoredMessage("Question: Describe City: Write a function called describe_city() that accepts the name of a city and its country. The function should print a simple sentence, such as 'Karachi is in Pakistan'. Give the parameter for the country a default value. Call your function for three different cities, at least one of which is not in the default country.");
    const describe_city = (city, country = "Default Country") => {
        console.log(`${city} is in ${country}.`);
    };
    describe_city("Karachi", "Pakistan");
