...
export const assingment15 = async() => {
    ...
    let guests: string[] = ['Hammad', 'Saqib', 'Zubair', 'Shahrukh'];
...
export const assingment18 = () => {
    printColoredMessage(
    "Question:Seeing the World: Think of at least five places in the world you’d like to visit.")
    let places: string[] = ['Tokyo', 'Paris', 'New York', 'Machu Picchu', 'Sydney'];
...
export const assingment19 = () => {
    printColoredMessage(
    "Question:Dinner Guests: Working with one of the programs from Exercises 14 through 18, print a message indicating the number of people you are inviting to dinner.")      
    let guests: string[] = ['Hammad', 'Saqib', 'Zubair', 'Shahrukh'];
...
export const assingment21 = () => {
    printColoredMessage(
    "Question:Conditional Tests: Write a series of conditional tests. Print a statement describing each test and your prediction for the results of each test. Your code should look something like this:")
...
export const assingment26 = (): void => {
...
export const assingment27 = (): void => {
...
export const assingment28 = async(): Promise<void> => {
    let alienColor: {color:string} = await inquirer.prompt([{ message: "Enter your favourite fruit name eg:banana,apple.orange etc:", type: "input", name: 'color' }]);;;
...
export const assingment29 = async () :  Promise<void> => {
    const favoriteFruits: string[] = ["banana", "apple", "orange"];
    let favouritefruitname: { name:string } = await inquirer.prompt([{ message: "Enter your favourite fruit name eg:banana,apple,orange etc:", type: "input", name: 'name' }]);;
    while (true){
...
export const assingment30 = async() => {
    ...
    const usernames: string[] = ["admin", "Eric", "Hammad", "Saqib", "John"];
