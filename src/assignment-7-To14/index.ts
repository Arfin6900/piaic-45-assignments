...
export const assingment7 = async() => {
    const favoriteNumber:{number:number} = await inquirer.prompt([{ message: "Enter your favorite number here :", type: "number", name: 'number' }]);
...
export const assingment9 = () => {
    printColoredMessage(
    "Question: Names: Store the names of a few of your friends in an array and print each person’s name by accessing each element in the list, one at a time.")
...
export const assingment10 = () => {
    printColoredMessage(
    "Question:  Print a personalized message to each person in an array.")
    const friends = ['Saqib', 'Shahrukh', 'Zubair'];
...
// Your Own Array: Print a series of statements about items in an array.
interface Assingment11{
    void:()=>number
}
export const assingment11 = () => {
    printColoredMessage(
    "Question: Your Own Array: Print a series of statements about items in an array.")
...
export const assingment12 = () => {
    printColoredMessage(
    "Question: Guest List: Print an invitation message to each person in an array.")
...
export const assingment13 = () : void => {
    printColoredMessage(
    "Question: Changing Guest List: Replace a guest and print a new set of invitation messages.")
...
export const assingment14 = () => {
    printColoredMessage(
    "Question: More Guests: Add more guests and print a new set of invitation messages.")
    const guests = ['Hammad', 'Saqib', 'Shahrukh'];
